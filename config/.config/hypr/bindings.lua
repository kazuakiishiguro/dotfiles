...
-- Personal bindings (migrated from the pre-Lua bindings.conf).
o.bind("SUPER + SHIFT + CTRL + N", "Org capture", 'uwsm-app -- alacritty --class org-zettel-edit -e emacsclient -t -a "" --eval "(org-capture)"')
o.bind("SUPER + SHIFT + Z", "Zettelkasten", "brave --app=http://localhost:8080")
o.bind("SUPER + SHIFT + S", "Syncthing", { webapp = "http://localhost:8384" })
